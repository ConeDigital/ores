                        ...
                        <ul id="nm-right-menu-ul" class="nm-menu">
                            ...
                            <li class="nm-menu-cart menu-item <?php echo esc_attr( $cart_menu_class ); ?>">
                                <a href="<?php echo esc_url( $cart_url ); ?>" id="nm-menu-cart-btn">
                                    <span class="nm-menu-cart-title"><?php echo esc_html__( 'Shopping bag', 'nm-framework' ) ;?></span>
                                    <div class="cd-header-bag">
                                        <img src="<?php echo esc_url(home_url( '/wp-content/themes/savoy-child/assets/images/big-paper-bag.png' ) ); ?>" />
